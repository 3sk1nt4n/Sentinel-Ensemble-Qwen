"""Console summary: the SENTINEL QWEN ENSEMBLE banner title renders inside its box at the
...
def test_title_box_line_keeps_visible_width():
    ...
    title_line = next(l for l in out.splitlines() if "SENTINEL QWEN ENSEMBLE" in l)
