...
if LIVE_MODE:
    ...
    _inv4_live_prompt = (
        ...
        "2. Attack Timeline (all timestamps in UTC) -- this is the ATTACK "
        "timeline: include ONLY confirmed_malicious_atomic events (the actual "
        "attack chain). Do NOT list benign/false-positive, inconclusive, or "
        "suspicious/needs-review observations here -- they belong in their own "
        "sections. If there are zero confirmed-malicious events, state that no "
        "confirmed-malicious activity was established on this evidence.\n"
